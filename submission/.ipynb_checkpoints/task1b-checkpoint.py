...
##load in the data
abt=pd.read_csv('abt.csv',encoding = 'ISO-8859-1').astype(str)
buy=pd.read_csv('buy.csv',encoding = 'ISO-8859-1').astype(str)
...
with open('abt_blocks.csv', 'w') as file:
...
with open('buy_blocks.csv', 'w') as file:
    writer = csv.writer(file)
    writer.writerow(['block_key', 'product_id'])
